...
export function EditTicketModal({ ticket, onClose, onSubmit }) {
  const { updateTicket, agentNames } = useTickets();
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[101] w-full h-screen flex items-center justify-center p-4 pointer-events-none">
        <div 
          ref={modalRef}
          className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-lg pointer-events-auto animate-scale-in"
